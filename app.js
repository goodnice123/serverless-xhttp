...
// 环境变量
const UUID = process.env.UUID || '231f268c-d7a8-436f-a097-3e58040e42e7'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'al2XWEwFTGTFUMjKwe';             // v1的NZ_CLIENT_SECRET或v0的agent端口  
...
const DOMAIN = process.env.DOMAIN || 'https://gisted-kano.hf.space';                   // 域名或ip,留空将自动获取服务器ip
